...
int main()
{
	...
	int input1,input2;	//These will be used in operations comparing user input,
				//for example verifying the pin, or changing the pin,
	...
	do
	{
		...
		switch(choice)
		{
			case '1':
			{
				...
				if((input1>HIGHEST || input1<LOWEST) && input1!=0)	//ie is it a four digit number other than zero
				{
